...
.mtx th.rot{height:96px; white-space:nowrap; vertical-align:bottom; padding-bottom:8px}
.mtx th.rot > div{transform:rotate(-52deg); transform-origin:left; width:20px; font-size:11px}
...
function buildMatrix(){
 ...
 THEMES.forEach(t=>h+='<th class="rot"><div>'+t+'</div></th>');
